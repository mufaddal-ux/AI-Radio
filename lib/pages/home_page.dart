...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton(
        "af71bbd8ab89f4ff600b7bf1a6b36a042e956eca572e1d8b807a3e2338fdd0dc/stage",
      ...
      body: Stack(
        children: [
          ...
          [
            ...
            "Start with -Hey Alan And say ".text.italic.semiBold.white.make(),
            10.heightBox,
            VxSwiper.builder(
